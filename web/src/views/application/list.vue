  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="评分材料" align="center" width="150">
        <template slot-scope="{row}">
          <span>{{ row.evaluation_material_id }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          <el-button type="primary" v-if="row.status=='0'" size="mini" @click="handleUpdate(row)">
            通过
          </el-button>
          ...
          >
            <el-button slot="reference" v-if="row.status=='0'" size="mini" type="danger" >
              拒绝
            </el-button>
          </el-popconfirm>
        </template>
